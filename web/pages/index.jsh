...
<div class="url-helper">
  <div class="url-paste">
    <form method="get" id="url-form">
      ...
      <input id="url" class="url" type="url" name="url" value="<!--# echo var="arg_url" encoding="none" default="" -->" placeholder="Paste GitHub, Bitbucket, GitLab, Gitea or Codeberg URL here" autofocus tabindex="1">
    </form>
  </div>
